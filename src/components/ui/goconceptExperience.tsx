...
const GoConceptExperience = () => {
    ...
    const logos = ["https://res.cloudinary.com/dzc4qte1c/image/upload/v1732035119/GoConcept_n6sq6w.svg", "https://res.cloudinary.com/dzc4qte1c/image/upload/v1732035117/Sice_vwcois.svg"];
    const links = [{url: "https://www.goconcept.com/en/",title : "Go Concept"},{url: "https://www.sice.com/", title: "Sice" }]
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start lg:justify-between relative w-full">
                ...
                <div className="flex flex-col h-fit relative lg:sticky lg:top-6 w-full lg:w-auto max-w-xl my-5">
                    <figure className="max-h-[369px] max-w-[480px] lg:max-w-[372px] mb-4">
                        <img src="https://res.cloudinary.com/dzc4qte1c/image/upload/v1732035109/gonzalocachon_A_programmer_working_in_a_bright_bustling_open-_bb087f21-170d-4587-80f1-708fddaf1c6a_3_ctvyen.png" alt="ilustration" className="w-full h-full rounded-2xl"/>
                    </figure>
                ...
                <div className="flex flex-col w-full max-w-xl lg:max-w-full">
                    ...
                    <div className="flex flex-row gap-3">
                        {links.map((link, index) => (
                            <a href={link.url} key={index} target="_blank" className="text-sub hover:text-white font-play text-sm lg:text-lg underline">{link.title}</a>
                        ))}
                    </div>
                </div>
            )}
