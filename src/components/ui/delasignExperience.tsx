...
const DelasignExperience = () => {
    ...
    const logos = ["https://res.cloudinary.com/dzc4qte1c/image/upload/v1732030537/delasignBlack_odneko.webp"];
    const links = [{url: "https://delasign.com/work/seemypath/",title : "See My Path"},{url: "https://delasign.com/work/priceafter/", title: "Price After" },{url:"https://delasign.com/collective/", title: "Delasign Collective"}]
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start lg:justify-between relative w-full">
                ...
                <div className="flex flex-col h-fit relative lg:sticky lg:top-6 w-full lg:w-auto max-w-xl my-5">
                    <figure className="max-h-[369px] max-w-[480px] lg:max-w-[372px] mb-4">
                        <img src="https://res.cloudinary.com/dzc4qte1c/image/upload/v1732030503/Delasign-ilustration_kng5og.png" alt="ilustration" className="w-full h-full rounded-2xl"/>
                    </figure>
